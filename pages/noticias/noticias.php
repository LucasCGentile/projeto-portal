...
<div class="container">
  ...
  <nav class="d-flex justify-content-between">
    <figure>
      <img src="https://placehold.co/250x140" alt="logo-noticias" class="img-fluid pt-3">
    </figure>
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-4">
      <img src="../../assets/images/noticia-image-1.jpeg" alt="" class="img-fluid">
      <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, ipsam?</h1>
      <p></p>
    </div>
    ...
    <!-- Noticia 2 -->
    <div class="col-12 col-md-4">
      <img src="../../assets/images/noticia-image-2.jpeg" alt="" class="img-fluid">
    ...
    <!-- Noticia 3 -->
    <div class="col-12 col-md-4">
      <img src="../../assets/images/noticia-image-3.jpeg" alt="" class="img-fluid">
  ...
  <section class="bg-now mt-4 rounded-3">
    ...
    <article class="row ">
      ...
      <section class="col m-3">
        <div class="card d-flex flex-row bg-transparent border-0">
          <img src="https://placehold.co/100x100" alt="" class="img-fluid img-resize-now">
          <div class="d-flex flex-column p-1">
            <p class="card-text">Prefeitura de Goiânia alerta para alta temperatura que pode atingir a Capital neste domingo (12/11), com possibilidade de chegar a 38°C</p>
  ...
  <aside class="mt-4 d-flex flex-column flex-lg-row justify-content-center align-items-center gap-1">
    <figure>
      <img src="https://placehold.co/650x300" alt="" class="img-fluid rounded-3">
    </figure>
  ...
  <footer class="pt-5">
    <div class="d-flex justify-content-between align-items-center">
      <img src="https://placehold.co/200x120" alt="logo-prefeitura">
