				...
				<div class="row">
					<div class="col-8 col-sm-6 col-md-12 col-lg-8">
						...
						<div class="col-sm-6 col-md-12 col-lg-8">
							<h5>Sábados</h5>
							<table
								class="table table-light table-hover table-bordered text-center align-middle"
							>
								<caption>
							...
							<div class="card">
								...
								<ul class="list-group list-group-flush">
									...
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/carmo.php"
											>Carmo via Ponta Porã</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/gabriel.php"
											>Gabriel Piza</a
										>
									</li>
									<li class="list-group-item">
									...
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/brasilia.php"
											>Jd. Brasília - São Rafael</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/mailasqui_vgp.php"
											>Mailasqui - Vargem Grande
										</a>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/mailasqui_vinhas.php"
											>Maislasqui - Vinhas do Sol</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/mont_serrat.php"
											>Mont Serrat</a
										>
									</li>
									<li class="list-group-item">
									...
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/pq_alianca.php"
											>Parque Aliança via Vila Amaral</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/planalto.php"
											>Planalto Verde (Darci Penteado)</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/ponte_lavrada.php"
											>Ponte Lavrada</a
										>
									</li>
									<li class="list-group-item">
									...
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/st_antonio.php"
											>Santo Antônio</a
										>
									</li>
									<li class="list-group-item">
									...
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../municipais/sorocamirim.php"
											>Sorocamirim - Pavão</a
										>
									</li>
									<li class="list-group-item">
								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/aluminio.php"
											>Alumínio</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/aracariguama.php"
											>Araçariguama</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/cotia.php"
											>Cotia</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/ibiuna.php"
											>Ibiúna</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/itapevi.php"
											>Itapevi</a
										>
									</li>
									<li class="list-group-item">
									...
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/mairinque.php"
											>Mairinque</a
										>
									</li>
									<li class="list-group-item">
										<a
											class="text-decoration-none text-black"
											href="../intermunicipais/sorocaba.php"
											>Sorocaba</a
										>
									</li>
								</ul>
