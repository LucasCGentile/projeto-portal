                    ...
                    <div>
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/mailasqui_vgp.php">Mailasqui - Vargem Grande
                                    </a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/mailasqui_vinhas.php">Maislasqui - Vinhas do Sol</a>
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/outlet.php">Outlet</a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/paisagem.php">Paisagem Colonial</a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/pq_alianca.php">Parque Aliança via Vila Amaral</a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/planalto.php">Planalto Verde (Darci Penteado)</a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/ponte_lavrada.php">Ponte Lavrada</a>
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../municipais/sorocamirim.php">Sorocamirim - Pavão</a>
                                </li>
                                <li class="list-group-item">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../intermunicipais/aluminio.php">Alumínio</a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../intermunicipais/aracariguama.php">Araçariguama</a>
                                </li>
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                ...
                                <li class="list-group-item">
                                    <a class="text-decoration-none text-black"
                                        href="../intermunicipais/itapevi.php">Itapevi</a>
                                </li>
                                <li class="list-group-item">
