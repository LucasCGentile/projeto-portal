<footer>
    ...
    <article class="container">
      ...
      <div class="d-lg-flex justify-content-between history-city pt-lg-5">
        ...
        <figure class="history-image order-2">
          <img src="./assets/images/foto-cidade.png" alt="foto da cidade" class="img-fluid pt-5 pt-lg-0 pb-3">
        </figure>
      ...
      <div class="pb-5">
        <ul class="text-light d-flex overflow-auto scroll gap-1">
          <li class="d-flex align-items-center fw-semibold p-3">Historia de São Roque</li>
          <li class="d-flex align-items-center fw-semibold p-3">Feiras</li>
          <li class="d-flex align-items-center fw-semibold p-3">Centros Culturais</li>
          <li class="d-flex align-items-center fw-semibold p-3">Biblioteca</li>
          <li class="d-flex align-items-center fw-semibold p-3">Telefones de Emergência</li>
          <li class="d-flex align-items-center fw-semibold p-3">Turismo</li>
          <li class="d-flex align-items-center fw-semibold p-3">Galeria de Ex-prefeitos</li>
          <li class="d-flex align-items-center fw-semibold p-3">Mais +</li>
        </ul>
      </div>
    </article>
  </div>
  ...
  <!-- Aplicativos // Todos -->
  <div class="footer">
    <article class="container d-lg-flex justify-content-between align-items-center">
      <!-- Footer First Column -->
      <div>
        <!-- Logo Prefeitura -->
        <div>
      ...
      <div class="bg-">
        <div class="d-md-none d-lg-block d-none d-flex">
          <div class="d-flex">
            <div class="p-4">
              <h3 class="text-success">Serviços <br> aos Cidadão</h3>
              <ul>
            ...
            <div class="p-4">
              <h3 class="text-success">Estrutura do <br> Governo</h3>
              <ul>
          ...
          <div class="d-flex">
            <div class="p-4">
              <h3 class="text-success">Portal da <br> Transparencia</h3>
              <ul>
            ...
            <div class="p-4">
              <h3 class="text-success">Ouvidoria <br> Municipal</h3>
              <ul>
